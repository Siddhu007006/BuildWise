    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-24">
        ...
        <div className="text-center max-w-5xl mx-auto mb-10">
          ...
          >
            <TypewriterEffect
              words={["BuildWise – AI Powered Construction Planning"]}
              className="text-balance"
              typingSpeed={50}
              pauseDuration={10000} // Effectively no delete loop since there is only one word
            />
          </h1>
          ...
          >
            Transform your construction projects with AI-powered estimation. Get accurate workforce planning, material calculations, and project schedules in minutes.
          </p>
        </div>
        ...
        >
          {[
            { value: "70%", label: "reduction in planning time", company: "AI POWERED" },
            { value: "99%", label: "estimation accuracy", company: "ML OPTIMIZED" },
            { value: "10x", label: "faster material calculation", company: "AUTOMATED" },
            { value: "Real-time", label: "project scheduling", company: "INSTANT" },
          ].map((stat) => (
